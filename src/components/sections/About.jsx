    ...
    return (
        <section id='about' className="flex items-center justify-center mb-40">
            <div className="max-w-2xl md:max-w-[44rem] lg:max-w-[58rem] mx-auto px-4">
                <h2 className="text-3xl text-center font-bold mb-5 text-gray-300">About <span className="bg-gradient-to-r from-blue-500 to-purple-600 
                bg-clip-text text-transparent">Me</span></h2>
                
                <div className="flex flex-col md:flex-row glass rounded-xl p-5 border-white/10 border hover:-translate-y-1 transition-all">
                    
                    <div className="flex w-full mb-5 sm:pr-5 md:mb-0">
