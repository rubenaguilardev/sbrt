                ...
                <div className="max-w-2xl md:max-w-[44rem] lg:max-w-[58rem] xl:max-w-6xl mx-auto px-4 md:px-1">
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col justify-evenly md:w-3/4 text-gray-300">
                            <div>
                                <h2 className="text-3xl text-center md:text-left font-bold mb-5 md:mb-7 lg:mb-0 text-gray-300"><span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">About </span>Me</h2> 
                            </div>
                            <div>
