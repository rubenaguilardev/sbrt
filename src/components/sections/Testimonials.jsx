    ...
    return(
        <section className="flex justify-center items-center mb-40">
            <div
                ...
                {...swipeHandlers}
            >
                <h2 className="text-[1.5rem] md:text-xl text-center font-bold mb-5 md:mb-7 text-gray-300">What <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Colleagues </span>Say About Me</h2>
