...
const WorkBottom = () => {
    ...
    const renderContent = section => {
        if (section.id === 0) {
            return (
                <div className="flex snap-x snap-mandatory overflow-x-auto gap-1 scroll-smooth hide-scrollbar min-w-0">
                    {section.content.map((instagram, index) => (
                        <div key={index}
                        className="snap-center shrink-0 max-w-md rounded-lg bg-white p-2">
