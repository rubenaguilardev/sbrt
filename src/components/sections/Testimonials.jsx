...
const Testimonials = () => {
    ...
    return(
        <section className="flex justify-center items-center mb-40">
            <div
                className="max-w-full md:w-[42.5rem] lg:w-[57.4rem] h-[540px] xl:w-[71.5rem] w-full m-auto relative group rounded-xlshadow-2xl" 
                {...swipeHandlers}
            >
                <h2 className="text-[1.375rem] md:text-xl text-center font-bold mb-5 md:mb-7 text-gray-300">What <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Colleagues </span>Say About Me</h2>
