        ...
        <section id='about' className="flex items-center justify-center mb-30">
            <RevealOnScroll>
                <div className="max-w-2xl md:max-w-[44rem] lg:max-w-[58rem] xl:max-w-6xl mx-auto px-4 md:px-1">
                    <h2 className="text-3xl text-center font-bold mb-5 md:mb-7 text-gray-300"><span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">About </span>Me</h2>
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col justify-center md:w-3/4 text-gray-300">
                            <p className="mb-5 md:mb-7">
                                I’m a marketing strategist with over a decade of experience bringing brands to life through social media, digital campaigns, photography, design, and events that get people talking. My approach blends creativity with strategy—turning big ideas into measurable impact.
                            </p>
                            <p className="mb-5 md:mb-7">
