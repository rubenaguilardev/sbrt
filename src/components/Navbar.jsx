...
const Navbar = ({menuOpen, setMenuOpen}) => {
    ...
    return (
        <nav 
            className="fixed top-0 w-full z-40 bg-[rgba(10, 10, 0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg"
        >
            <div className="max-w-5xl mx-auto px-4">
                <div className="flex justify-between item-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href='#work' className="text-gray-300 hover:text-white transition-colors">My Work</a>
