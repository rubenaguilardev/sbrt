import storytelling from "../assets/skills/1.avif";
import photography from "../assets/skills/2.avif";
import event from "../assets/skills/3.avif";
import food from "../assets/skills/4.avif";
import storytellingSM from "../assets/skills/1sm.avif";
import photographySM from "../assets/skills/2sm.avif";
import eventSM from "../assets/skills/3sm.avif";
...
import blog4 from "../assets/blogs/4.avif";
...
export const SKILLS = [
  ...
  },
  {
    ...
    image: photography,
    description:
      "Capturing moments with artistic flair and emotional resonance",
  },
  {
